    ...
    for r in range(3, 2, -1):
        ...
        for i in range(1, 2, 1):
            ...
            for i in range(1):
                ...
                if methods == "random":
                    if avedeg:
                        poolist1.append(p1.apply_async(cm.Random, args=(copy.deepcopy(nodeAttribute),copy.deepcopy(nodeNeighbors),coverS,evolutionmodel,initsize,copy.deepcopy(edge),6,Opinion,False,timebound,sizebound,)))
                    else:
                        poolist1.append(p1.apply_async(cm.Random, args=(
                        copy.deepcopy(nodeAttribute), copy.deepcopy(nodeNeighbors), coverS, evolutionmodel, initsize,copy.deepcopy(edge),)))
                else:
    ...
    for r in range(3, 2, -1):
        ...
        for i in range(1, 2, 1):
            ...
            for i in range(2):
                ...
                if methods == "random":
                    if avedeg:
                        poolist1.append(p1.apply_async(cm.Random, args=(copy.deepcopy(nodeAttribute),copy.deepcopy(nodeNeighbors),coverS,evolutionmodel,initsize,copy.deepcopy(edge),6,Opinion,True,timebound,sizebound,)))
                    else:
                        poolist1.append(p1.apply_async(cm.Random, args=(
                        copy.deepcopy(nodeAttribute), copy.deepcopy(nodeNeighbors), coverS, evolutionmodel, initsize,copy.deepcopy(edge),)))
                else:
        ...
        with multiprocessing.Lock():
            ...
            f.write("size:" + str(ss) + "\n")
            f.close()
def dynamicMethods(nodeAttribute,nodeNeighbors,initsize,evolutionmodel,methods,r,coverS,edges=None,avedeg=None,opinion=None,static=False,sizebound=None,timebound=None,duration=4):
    count=0
    Cost=[0,0]   #jump, walk
    a = 0
    clock=0
...
if __name__ == '__main__':
    ...
    # ModelTest2(e, "Rmax")
    # ModelTest(e,i,"Smax")
    # ModelTest(e, i, "Overlapping")
    # ModelTest(e, i, "random")
    ...
    e="SBM"
    # ModelTest1(e,"Rmax",avedeg=6)
    ModelTest1(e, "Smax",avedeg=6)
    # ModelTest1(e, "Overlapping",avedeg=6)
    # ModelTest1(e, "random",avedeg=6)
    # ModelTestAR1(e,5000)
    ...
    # for m in ["Overlapping"]:#,，"Rmax","random","Smax",
    ...
    # ModelTestAR2(e,5000,3,avedeg=6)
