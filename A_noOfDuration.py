...
def test1(evolutionmodel,initsize,methods,duration):
    """
    ...
    for r in range(4,2,-1):
        ...
        tmp,cost=dynamicMethods(copy.deepcopy(nodeAttribute), copy.deepcopy(nodeNeighbors), initsize, evolutionmodel, methods, r, coverS,duration,)
...
def dynamicMethods(nodeAttribute,nodeNeighbors,initsize,evolutionmodel,methods,r,coverS,duration,edges=None,avedeg=None,opinion=None):
    count=0
    Cost=[0,0]   #jump, walk
    a = 0
    interval = 1
    while len(coverS.CS)<len(nodeAttribute.keys()):
        ...
        #     res, Cost = cm.NumofNewEdgePercentage(nodeAttribute, nodeNeighbors, r, Cost, coverS,duration=duration)
        #     coverS.updateBS(nodeNeighbors, [res])
        # elif methods== "Overlapping2":
        #     res, Cost = cm.NumofNewEdgeUp(nodeAttribute, nodeNeighbors, r, Cost, coverS,duration=duration)
        #     coverS.updateBS(nodeNeighbors, [res])
...
def statiCases(evolutionmodel,endsize,r=100):
    ...
    # p1 = multiprocessing.Pool(2)
        coverS = cm.coverSet(r)
        tmp,cost,opinion=cm.AlternateRandom2(copy.deepcopy(nodeAttribute), copy.deepcopy(nodeNeighbors), copy.deepcopy(coverS))
...
def Random(evolutionmodel,startsize):
    ...
    for r in range(8,1,-1):
        ...
        # p1 = multiprocessing.Pool(2)
        coverS = cm.coverSet(r)
        tmp=cm.Random(copy.deepcopy(nodeAttribute), copy.deepcopy(nodeNeighbors), coverS, evolutionmodel, startsize, None,
